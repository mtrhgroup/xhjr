...
int cdataHook (struct dom_data *data, char *cdata, size_t len);
int tagHook (struct dom_data *data, char *name, char **atts, int type);
void deleteHook (struct dom_data *data);
