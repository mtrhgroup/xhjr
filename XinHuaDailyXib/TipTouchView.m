...
@synthesize btn=_btn;
- (id)init{
    float cell_width=[[UIScreen mainScreen] applicationFrame].size.width;
    self = [super initWithFrame:CGRectMake(0, 0, cell_width, 44)];
    ...
    _btn=[[UIButton alloc] initWithFrame:CGRectMake(0, 0, cell_width, 44)];
