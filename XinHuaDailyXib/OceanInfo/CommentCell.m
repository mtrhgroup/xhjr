...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        time_lbl = [[UILabel alloc] initWithFrame:CGRectMake(cell_width-160, 5, 150, 20)];
...
-(void)setComment:(Comment *)comment{
    ...
    content_size= [content_lbl.text sizeWithFont:content_lbl.font constrainedToSize:CGSizeMake(cell_width-20, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping];
