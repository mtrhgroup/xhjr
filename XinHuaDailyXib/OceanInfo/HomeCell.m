...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _comment_icon=[[UIImageView alloc] initWithFrame:CGRectMake(cell_width-18, 70, 17, 17)];
        _comment_icon.image=[UIImage imageNamed:@"button_review.png"];
        [self.contentView addSubview:_comment_icon];
        
        _comment_number_lbl = [[UILabel alloc] initWithFrame:CGRectMake(cell_width-43, 70, 25, 17)];
        ...
        _like_icon=[[UIImageView alloc] initWithFrame:CGRectMake(cell_width-60, 70, 17, 17)];
        _like_icon.image=[UIImage imageNamed:@"button_wonderful.png"];
        [self.contentView addSubview:_like_icon];
        
        _like_number_lbl = [[UILabel alloc] initWithFrame:CGRectMake(cell_width-85, 70, 25, 17)];
