...
- (void)viewDidLoad
{
    ...
    layerFrame.size.height = self.view.frame.size.height;
...
-(void)viewWillLayoutSubviews{
    ...
    layerFrame.size.height = self.view.bounds.size.height;
    layerFrame.origin.y = 0;
    animationLayer.frame = layerFrame;
}
...
-(UIViewController*)popViewControllerAnimated:(BOOL)animated
{
    ...
    if(animated)
    {
        ...
        rotationAndPerspectiveTransform1.m34 = 1.0 / -1000;
        rotationAndPerspectiveTransform1 = CATransform3DMakeScale(1.0, 1.0, 1.0);
        [Animation1 setFromValue:[NSValue valueWithCATransform3D:CATransform3DMakeScale(0.95, 0.95, 0.95)]];
