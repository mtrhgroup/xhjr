...
@synthesize web_delegate=_web_delegate;
...
-(void)setSelectedFontSize:(NSString *)fontSize{
    if([fontSize isEqualToString:@"特大"]){
        selectedIndex=[NSIndexPath indexPathForRow:0 inSection:0];
    }else if([fontSize isEqualToString:@"较大"]){
        selectedIndex=[NSIndexPath indexPathForRow:1 inSection:0];
    }else if([fontSize isEqualToString:@"正常"]){
        selectedIndex=[NSIndexPath indexPathForRow:2 inSection:0];
    }else if([fontSize isEqualToString:@"较小"]){
...
- (void)initTheInterface
{
    ...
    self.titleName.backgroundColor = [UIColor colorWithRed:248.0/255 green:248.0/255 blue:248.0/255 alpha:1.0];
    ...
    [self.mainPopoverListView selectRowAtIndexPath:selectedIndex animated:YES scrollPosition:UITableViewScrollPositionTop];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"%@", fonts[indexPath.row]];
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.web_delegate changeFontWithFontSize:fonts[indexPath.row]];
    [self dismiss];
}
