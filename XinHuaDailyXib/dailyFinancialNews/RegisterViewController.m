...
- (void)viewDidLoad
{
    ...
    subscribe_phone.text=@"订购热线：010-63073644";
    subscribe_phone.backgroundColor=[UIColor clearColor];
    subscribe_phone.textColor=[UIColor redColor];
    ...
    techsupport_phone.textColor=[UIColor redColor];
...
-(void)callSubscribe{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"tel://01063073644"]];
}
