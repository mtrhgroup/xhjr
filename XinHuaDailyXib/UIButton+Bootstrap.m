...
-(void)primaryStyle{
    [self bootstrapStyle];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:66/255.0 green:139/255.0 blue:202/255.0 alpha:1]] forState:UIControlStateNormal];
...
//    self.layer.borderColor = [[UIColor colorWithRed:212/255.0 green:63/255.0 blue:58/255.0 alpha:1] CGColor];
    ...
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:217/255.0 green:83/255.0 blue:79/255.0 alpha:1]] forState:UIControlStateNormal];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:210/255.0 green:210/255.0 blue:210/255.0 alpha:1]] forState:UIControlStateDisabled];
}
